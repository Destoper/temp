...
function buildScene() {
	...
	let sistemaSolar 		= new THREE.InstancedMesh( 	new THREE.SphereGeometry( 1.0, 10, 10), 
	...
	// Sol
	let transfMat = new THREE.Matrix4().makeScale(4.0, 4.0, 4.0);
...
let obj = scene.getObjectByName("SistemaSolar");
